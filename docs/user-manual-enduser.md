# User Manual — End User — IDaaS
> Version: 1.0 | Last Updated: 2026-02-18 | Status: Draft
> Classification: Internal | Author: AIDD System

## 1. Introduction

Welcome to IDaaS! This guide helps you get started and make the most of the platform.
...
- **Create**: Click "New" → fill in details → Save
- **View**: Browse the list or use search
- **Edit**: Click on any resource → modify → Save
